...
export default function Sidebar({ currentUser, language = 'en', activeTab, setActiveTab, reports, onLogout }) {
  ...
  const empMenu = [
    ...
    { id: 'my-reports', label: t.myReportsNav, icon: FileText },
  ...
  const adminMenu = [
    ...
    { id: 'reports-by-area', label: t.reportsByAreaNav, icon: Layers, highlight: true },
